...
describe('350. Intersection of Two Arrays II', () => {
    it('should return array [2, 2]', () => {
        let nums1 = [1, 2, 2, 1];
        let nums2 = [2, 2];

        assert.deepEqual([2, 2], index.intersect(nums1, nums2));
    });

    it('shoudl return array [4, 9]', () => {
        let nums1 = [4, 9, 5];
        let nums2 = [9, 4, 9, 8, 4];

        assert.deepEqual([4, 9], index.intersect(nums1, nums2));
    });

    it('should return array [5, 4, 57, 79, 7, 89, 88, 45, 34, 92, 38, 85, 6, 0, 77, 44, 61]', () => {
        let nums1 = [
        ...
        // assert.deepEqual(expected, index.intersect(nums1, nums2));
    });
});
